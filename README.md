...
- CSP and Permissions-Policy apply in dev and prod via `resume_builder/settings/base.py`; production also sets HSTS, Referrer-Policy, and related hardening in `resume_builder/settings/prod.py`
